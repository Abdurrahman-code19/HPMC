            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">123 Ahmadu Bello Way<br />Jos, Plateau State<br />Nigeria</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">+234 803 123 4567<br />+234 809 876 5432</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@hpmc.coop<br />support@hpmc.coop</p>
                    </div>
                  </div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-heading font-bold text-xl mb-1">Chat on WhatsApp</h3>
                    <p className="text-white/80">Get instant response to your questions</p>
                  </div>
                </div>
              </a>
